      ...
      <div className="relative mx-auto flex min-h-screen max-w-6xl items-center justify-center px-6">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-[32px] border-2 border-black/70 bg-white shadow-[0_22px_0_rgba(0,0,0,0.10)]">
            {/* gradient wash */}
            <div className="absolute inset-0 bg-gradient-to-br from-pink-200/60 via-white to-emerald-200/50" />
            ...
            <div className="relative p-7">
              <div className="text-center">
                ...
                <h1 className="mt-5 text-3xl font-black tracking-tight">
                  ...
                  <span className="relative inline-block">
                    <span className="ml-2 bg-gradient-to-r from-purple-600 via-pink-600 to-emerald-600 bg-clip-text text-transparent">
                      instantly
                    </span>
                ...
                <p className="mt-4 text-sm font-semibold text-black/70">
                  Sign up with Google to offer skills, request help,
                  and schedule sessions with other students.
                </p>
              </div>
              ...
              <div className="mt-6 flex items-center justify-center gap-2 text-xs font-semibold text-black/60">
                ...
                Google-verified • no passwords stored
              </div>
          ...
          <div className="mt-6 text-center text-xs font-semibold text-black/55">
            By continuing, you agree to SkillSwap’s Terms & Privacy Policy
          </div>
        </motion.div>
      </div>
    </main>
